...
{
    internal static string GetRepositoryDataFilePath(string fileName)
    {
        ...
        {
            var dataFilePath = Path.Combine(directory.FullName, "data", fileName);
        ...
        throw new FileNotFoundException(
            $"Could not find '{fileName}' under the repository data directory.",
            fileName);
    }
